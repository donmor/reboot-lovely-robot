...
public class LovelyRobotItems {
    ...
    public static final RegistryObject<Item> VANILLA_SPAWN = ITEMS.register(LovelyRobotID.VANILLA_SPAWN, () -> new SpawnItem(LovelyRobotEntities.VANILLA.get(), new Item.Properties().tab(LovelyRobotItemsGroup.LOVELY_ROBOT).rarity(Rarity.RARE).fireResistant().stacksTo(1)));
